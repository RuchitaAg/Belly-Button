...
function buildCharts(sample) {
  ...
  d3.json("data/samples.json").then((data) => {
    ...
    var filtered_samples=samples_array.filter(obj=>obj.id==sample);

    var metadata_array=data.metadata;
    var filtered_metadata=metadata_array.filter(obj=>obj.id==sample);
    ...
    var values=first_sample.sample_values.slice(0,10).reverse();

    var labels_bubble=first_sample.otu_labels;
    var values_bubble=first_sample.sample_values;

    var washing_freq=first_metadata.wfreq;
